...
RestEase is a little type-safe REST API client library for .NET Framework 4.0 and higher and .NET Core (.NET Platform Standard 1.1, PCL profiles 7, 32, 44, 111, 151), which aims to make interacting with remote REST endpoints easy, without adding unnecessary compexity.
