    ...
    public class EmitImplementationFactory
    {
        ...
        private Type GetImplementation(Type interfaceType)
        {
            ...
            if (interfaceType.GetTypeInfo().IsGenericType)
            {
                ...
                {
                    implementationTypeDefinition = this.BuildEmitImplementation(typeDefinition);
            ...
            {
                return this.BuildEmitImplementation(interfaceType);
            }
        }

        private Type BuildEmitImplementation(Type interfaceType)
        {
